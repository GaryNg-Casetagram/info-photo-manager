        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              <h3 className="font-bold text-xl">📊 Expense Manager</h3>
            </div>
            <p className="text-gray-600 mb-4 max-w-md">
              Professional expense tracking and receipt management for business claims. 
              Streamline your financial data with our modern, secure platform.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/expenses" className="text-gray-600 hover:text-gray-900 transition-colors">
                  Expense Management
                </Link>
              </li>
              <li>
              ...
              <li>
                <a href="#export" className="text-gray-600 hover:text-gray-900 transition-colors">
                  Data Export
                </a>
              </li>
              <li>
